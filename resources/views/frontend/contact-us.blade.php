...
@section('content')
    ...
    <div class="section mt-negative pt-0">
        <div class="container">
            ...
            <form class="sigma_box box-lg m-0 mf_form_validate ajax_submit"
                  action="https://slidesigma.com/themes/html/mircco/sendmail.php" method="post"
                ...
                <div class="form-group">
                    <textarea name="message" placeholder="Enter Message" cols="45" rows="5"
