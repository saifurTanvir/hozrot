                    ...
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="sigma_box m-0">
                                <p class="custom-primary mb-0 fw-600 fs-16">Aug 12, 2022</p>
                                <h4 class="title">A few words about us</h4>
                                <p class="m-0"> As long as there are people coming to the mosque, Islam will keep on
                                    spreading the word of peace. This is where you should start The Shaha is not just a
                                    mosque for prayers rather it is a community center for all. The Shaha is not just a
                                    mosque for prayers rather it is a community center for all. This is where you should
                                    start Lorem ipsum dolor sit amet consectetur</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <article class="sigma_post">
                        ...
                        <div class="sigma_post-body">
                            ...
                            <h5><a href="blog-details.html">Give Shelter Homes</a></h5>
                            <div class="sigma_post-single-author">
                                <img src="assets/img/people/1.jpg" alt="author">
                                <div class="sigma_post-single-author-content">
                                    By <p>Yaseen Asad</p>
