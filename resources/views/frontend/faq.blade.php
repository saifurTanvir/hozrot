...
@section('content')
      ...
      <div class="row">
          ...
          <div class="accordion with-gap" id="generalFAQExample">
            <div class="card">
              ...
              <div id="generalOne" class="collapse show" data-bs-parent="#generalFAQExample">
                <div class="card-body">
                  A Mosque is the house of Allah where People pray to Allah. As long as there are people coming to the mosque, Islam will keep on spreading the word of peace and which will increase the love of Allah
                </div>
              </div>
            </div>
            <div class="card">
            ...
            <div class="card">
              <div class="card-header" data-bs-toggle="collapse" role="button" data-bs-target="#generalSeven" aria-expanded="false" aria-controls="generalSeven">
        ...
        <div class="col-lg-6">
          <div class="accordion with-gap" id="generalFAQExample2">
            <div class="card">
              <div class="card-header" data-bs-toggle="collapse" role="button" data-bs-target="#generalFour" aria-expanded="true" aria-controls="generalFour">
            ...
            <div class="card">
              <div class="card-header" data-bs-toggle="collapse" role="button" data-bs-target="#generalFive" aria-expanded="false" aria-controls="generalFive">
            ...
            <div class="card">
              <div class="card-header" data-bs-toggle="collapse" role="button" data-bs-target="#generalSix" aria-expanded="false" aria-controls="generalSix">
                How to migrate my website?
              </div>
            ...
            <div class="card">
              <div class="card-header" data-bs-toggle="collapse" role="button" data-bs-target="#generalEight" aria-expanded="false" aria-controls="generalEight">
  ...
  <!-- Form Start -->
  <div class="section dark-overlay dark-overlay-3 bg-cover bg-center bg-norepeat" style="background-image: url(assets/img/bg4.jpg)">
    <div class="container">
